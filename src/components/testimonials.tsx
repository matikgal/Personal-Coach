export default function testimonials() {
	return (
		<div className="bg-gray-50 py-16 px-6 md:px-20">
			...
			<div className="flex flex-col md:flex-row justify-center md:space-x-8 space-y-8 md:space-y-0 container items mx-auto">
				<div className="bg-white shadow-lg rounded-lg p-6 md:w-1/3 mx-auto transition transform hover:scale-105 font-opensans">
